...
class LifeCycle {
     ...
     */
    reportVersionIssues(version, aboutWhatMessage, printWarnings) {
...
class StructureVersionInfo extends VersionInfo {
    ...
    checkStructureVersion(instance, includeWarnings) {
        const { availability } = this;
        const { metaModelVersion } = instance.model;
        const { structureTypeName } = instance;
        const hasVersionIssues = availability.reportVersionIssues(metaModelVersion, `Type '${structureTypeName}'`, includeWarnings);
        if (!hasVersionIssues) {
