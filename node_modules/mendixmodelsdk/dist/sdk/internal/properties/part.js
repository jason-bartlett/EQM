...
class PartProperty extends abstract_property_1.AbstractProperty {
    ...
    updateWithRawValue(value) {
        const newChild = instances_1.instancehelpers.modelElementJsonToInstance(this.parent._model, this.parent.unit, this.parent, value, this.parent._isPartial);
...
class PartListProperty extends abstract_property_1.AbstractProperty {
    ...
    updateWithRawValue(value) {
        const newChildren = value.map(e => instances_1.instancehelpers.modelElementJsonToInstance(this.parent._model, this.parent.unit, this.parent, e, this.parent._isPartial));
