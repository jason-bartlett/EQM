...
import { Delta } from "../internal";
import { ILockWorkingCopyResponse, IWorkingCopy, IAbstractUnitJson, IEnvironmentStatus, IDeployJobStatus, IGetFilesOptions, ILockWorkingCopyOptions, LockType } from "./transport-interfaces";
/**
...
export interface IModelServerClient {
     ...
     */
    loadUnitInterfaces(workingCopyId: string, callback: common.ICallback<IAbstractUnitJson[]>, errorCallback: common.IErrorCallback): void;
    /**
    ...
    importModuleMpk(workingCopyId: string, mpkPath: string, callback: common.IVoidCallback, errorCallback: common.IErrorCallback): void;
    /**
     * Retrieves a unit, as normalized model JSON, by working copy and unit ID.
     */
    loadUnitById(workingCopyId: string, unitId: string, callback: common.ICallback<IAbstractUnitJson>, errorCallback: common.IErrorCallback): void;
    /**
