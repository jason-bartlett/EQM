...
(function (domainmodels) {
    ...
    class AccessRule extends internal.Element {
        ...
        get containerAsEntity() { return super.getContainerAs(Entity); }
        get containerAsAccessRuleContainerBase() { return super.getContainerAs(security_1.security.AccessRuleContainerBase); }
        get memberAccesses() { return this.__memberAccesses.get(); }
        ...
        get allowCreate() { return this.__allowCreate.get(); }
        set allowCreate(newValue) { this.__allowCreate.set(newValue); }
        get allowDelete() { return this.__allowDelete.get(); }
        set allowDelete(newValue) { this.__allowDelete.set(newValue); }
        get defaultMemberAccessRights() { return this.__defaultMemberAccessRights.get(); }
        set defaultMemberAccessRights(newValue) { this.__defaultMemberAccessRights.set(newValue); }
        /**
    ...
    class Annotation extends internal.Element {
        ...
        get containerAsDomainModel() { return super.getContainerAs(DomainModel); }
    ...
    class AssociationBase extends internal.Element {
        ...
        get dataStorageGuid() { return this.__dataStorageGuid.get(); }
        set dataStorageGuid(newValue) { this.__dataStorageGuid.set(newValue); }
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get owner() { return this.__owner.get(); }
        set owner(newValue) { this.__owner.set(newValue); }
        get deleteBehavior() { return this.__deleteBehavior.get(); }
        set deleteBehavior(newValue) { this.__deleteBehavior.set(newValue); }
        get parent() { return this.__parent.get(); }
        set parent(newValue) { this.__parent.set(newValue); }
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
        /** @internal */
    ...
    class Association extends AssociationBase {
        ...
        get containerAsDomainModel() { return super.getContainerAs(DomainModel); }
        get child() { return this.__child.get(); }
        set child(newValue) { this.__child.set(newValue); }
        get parentConnection() { return this.__parentConnection.get(); }
        set parentConnection(newValue) { this.__parentConnection.set(newValue); }
        get childConnection() { return this.__childConnection.get(); }
        set childConnection(newValue) { this.__childConnection.set(newValue); }
        /**
    ...
    class AssociationDeleteBehavior extends internal.Element {
        ...
        get containerAsAssociationBase() { return super.getContainerAs(AssociationBase); }
        get parentDeleteBehavior() { return this.__parentDeleteBehavior.get(); }
        set parentDeleteBehavior(newValue) { this.__parentDeleteBehavior.set(newValue); }
        get childDeleteBehavior() { return this.__childDeleteBehavior.get(); }
        set childDeleteBehavior(newValue) { this.__childDeleteBehavior.set(newValue); }
        get parentErrorMessage() { return this.__parentErrorMessage.get(); }
        set parentErrorMessage(newValue) { this.__parentErrorMessage.set(newValue); }
        get childErrorMessage() { return this.__childErrorMessage.get(); }
        set childErrorMessage(newValue) { this.__childErrorMessage.set(newValue); }
        /**
    ...
    class MemberRef extends internal.Element {
        ...
        get containerAsAttributeWidget() { return super.getContainerAs(documenttemplates_1.documenttemplates.AttributeWidget); }
        get containerAsDataGridColumn() { return super.getContainerAs(documenttemplates_1.documenttemplates.DataGridColumn); }
        get containerAsDocumentTemplatesGridSortItem() { return super.getContainerAs(documenttemplates_1.documenttemplates.GridSortItem); }
        get containerAsVariableRefExpression() { return super.getContainerAs(expressions_1.expressions.VariableRefExpression); }
        get containerAsSortItem() { return super.getContainerAs(microflows_1.microflows.SortItem); }
        get containerAsClientTemplateParameter() { return super.getContainerAs(pages_1.pages.ClientTemplateParameter); }
        get containerAsGridColumn() { return super.getContainerAs(pages_1.pages.GridColumn); }
        get containerAsPagesGridSortItem() { return super.getContainerAs(pages_1.pages.GridSortItem); }
        get containerAsListViewSearch() { return super.getContainerAs(pages_1.pages.ListViewSearch); }
        get containerAsMemberWidget() { return super.getContainerAs(pages_1.pages.MemberWidget); }
        get containerAsRangeSearchField() { return super.getContainerAs(pages_1.pages.RangeSearchField); }
        get containerAsSingleSearchField() { return super.getContainerAs(pages_1.pages.SingleSearchField); }
        get containerAsStaticOrDynamicString() { return super.getContainerAs(pages_1.pages.StaticOrDynamicString); }
    ...
    class AttributeRef extends MemberRef {
         ...
         *  7.11.0 and higher
         */
        static createInAttributeValueUnderValue(container) {
            internal.createInVersionCheck(container.model, AttributeRef.structureTypeName, { start: "7.11.0" });
    ...
    class AttributeType extends internal.Element {
        ...
        get containerAsAttribute() { return super.getContainerAs(Attribute); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class CalculatedValue extends ValueType {
        ...
        get passEntity() { return this.__passEntity.get(); }
        set passEntity(newValue) { this.__passEntity.set(newValue); }
        /**
    ...
    class CrossAssociation extends AssociationBase {
        ...
        get child() { return this.__child.get(); }
        set child(newValue) { this.__child.set(newValue); }
        get childQualifiedName() { return this.__child.qualifiedName(); }
        /**
    ...
    class DateTimeAttributeType extends AttributeType {
        ...
        get containerAsAttribute() { return super.getContainerAs(Attribute); }
        get localizeDate() { return this.__localizeDate.get(); }
        set localizeDate(newValue) { this.__localizeDate.set(newValue); }
        /**
    ...
    class EntityRef extends internal.Element {
        ...
        get containerAsWidgetValue() { return super.getContainerAs(customwidgets_1.customwidgets.WidgetValue); }
        get containerAsEntityWidget() { return super.getContainerAs(documenttemplates_1.documenttemplates.EntityWidget); }
        get containerAsMemberRef() { return super.getContainerAs(MemberRef); }
        get containerAsEntityPathSource() { return super.getContainerAs(pages_1.pages.EntityPathSource); }
        get containerAsNewButton() { return super.getContainerAs(pages_1.pages.NewButton); }
        get containerAsReferenceSetSelector() { return super.getContainerAs(pages_1.pages.ReferenceSetSelector); }
        get containerAsSelectorXPathSource() { return super.getContainerAs(pages_1.pages.SelectorXPathSource); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class DomainModel extends projects_1.projects.ModuleDocument {
        ...
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
        get entities() { return this.__entities.get(); }
        get annotations() { return this.__annotations.get(); }
        get associations() { return this.__associations.get(); }
        get crossAssociations() { return this.__crossAssociations.get(); }
        /**
    ...
    class Entity extends internal.Element {
        ...
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
        get generalization() { return this.__generalization.get(); }
        set generalization(newValue) { this.__generalization.set(newValue); }
        get attributes() { return this.__attributes.get(); }
        get validationRules() { return this.__validationRules.get(); }
        get eventHandlers() { return this.__eventHandlers.get(); }
        get indexes() { return this.__indexes.get(); }
    ...
    class EntityRefStep extends internal.Element {
        ...
        get containerAsIndirectEntityRef() { return super.getContainerAs(IndirectEntityRef); }
        get association() { return this.__association.get(); }
        set association(newValue) { this.__association.set(newValue); }
        get associationQualifiedName() { return this.__association.qualifiedName(); }
        get destinationEntity() { return this.__destinationEntity.get(); }
        set destinationEntity(newValue) { this.__destinationEntity.set(newValue); }
        get destinationEntityQualifiedName() { return this.__destinationEntity.qualifiedName(); }
        /**
    ...
    class EnumerationAttributeType extends AttributeType {
        ...
        get containerAsAttribute() { return super.getContainerAs(Attribute); }
        get enumeration() { return this.__enumeration.get(); }
        set enumeration(newValue) { this.__enumeration.set(newValue); }
        get enumerationQualifiedName() { return this.__enumeration.qualifiedName(); }
        /**
    ...
    class RuleInfo extends internal.Element {
        ...
        get containerAsValidationRule() { return super.getContainerAs(ValidationRule); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class EqualsToRuleInfo extends RuleInfo {
        ...
        get containerAsValidationRule() { return super.getContainerAs(ValidationRule); }
        get useValue() { return this.__useValue.get(); }
        set useValue(newValue) { this.__useValue.set(newValue); }
        get equalsToValue() { return this.__equalsToValue.get(); }
        set equalsToValue(newValue) { this.__equalsToValue.set(newValue); }
        get equalsToAttribute() { return this.__equalsToAttribute.get(); }
        set equalsToAttribute(newValue) { this.__equalsToAttribute.set(newValue); }
        get equalsToAttributeQualifiedName() { return this.__equalsToAttribute.qualifiedName(); }
        /**
    ...
    class EventHandler extends internal.Element {
        ...
        get containerAsEntity() { return super.getContainerAs(Entity); }
        get moment() { return this.__moment.get(); }
        set moment(newValue) { this.__moment.set(newValue); }
        get event() { return this.__event.get(); }
        set event(newValue) { this.__event.set(newValue); }
        get microflow() { return this.__microflow.get(); }
        set microflow(newValue) { this.__microflow.set(newValue); }
        get microflowQualifiedName() { return this.__microflow.qualifiedName(); }
        get raiseErrorOnFalse() { return this.__raiseErrorOnFalse.get(); }
        set raiseErrorOnFalse(newValue) { this.__raiseErrorOnFalse.set(newValue); }
        get passEventObject() { return this.__passEventObject.get(); }
        set passEventObject(newValue) { this.__passEventObject.set(newValue); }
        /**
    ...
    class Generalization extends GeneralizationBase {
        ...
        get generalization() { return this.__generalization.get(); }
        set generalization(newValue) { this.__generalization.set(newValue); }
        get generalizationQualifiedName() { return this.__generalization.qualifiedName(); }
        /**
    ...
    class IndexedAttribute extends internal.Element {
        ...
        get containerAsIndex() { return super.getContainerAs(Index); }
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get attribute() { return this.__attribute.get(); }
        set attribute(newValue) { this.__attribute.set(newValue); }
         ...
         */
        get ascending() { return this.__ascending.get(); }
        set ascending(newValue) { this.__ascending.set(newValue); }
        /**
    ...
    class IndirectEntityRef extends EntityRef {
        ...
        get containerAsReferenceSetSelector() { return super.getContainerAs(pages_1.pages.ReferenceSetSelector); }
        get containerAsSelectorXPathSource() { return super.getContainerAs(pages_1.pages.SelectorXPathSource); }
        get steps() { return this.__steps.get(); }
        /**
    ...
    class MemberAccess extends internal.Element {
        ...
        get containerAsAccessRule() { return super.getContainerAs(AccessRule); }
        get attribute() { return this.__attribute.get(); }
        set attribute(newValue) { this.__attribute.set(newValue); }
        get attributeQualifiedName() { return this.__attribute.qualifiedName(); }
        get association() { return this.__association.get(); }
        set association(newValue) { this.__association.set(newValue); }
        get associationQualifiedName() { return this.__association.qualifiedName(); }
        get accessRights() { return this.__accessRights.get(); }
        set accessRights(newValue) { this.__accessRights.set(newValue); }
        /**
    ...
    class NoGeneralization extends GeneralizationBase {
        ...
        get containerAsEntity() { return super.getContainerAs(Entity); }
        get hasChangedDate() { return this.__hasChangedDate.get(); }
        set hasChangedDate(newValue) { this.__hasChangedDate.set(newValue); }
        get hasCreatedDate() { return this.__hasCreatedDate.get(); }
        set hasCreatedDate(newValue) { this.__hasCreatedDate.set(newValue); }
        get hasOwner() { return this.__hasOwner.get(); }
        set hasOwner(newValue) { this.__hasOwner.set(newValue); }
        get hasChangedBy() { return this.__hasChangedBy.get(); }
        set hasChangedBy(newValue) { this.__hasChangedBy.set(newValue); }
        get persistable() { return this.__persistable.get(); }
        set persistable(newValue) { this.__persistable.set(newValue); }
        /**
    ...
    class RangeRuleInfo extends RuleInfo {
        ...
        get containerAsValidationRule() { return super.getContainerAs(ValidationRule); }
        get typeOfRange() { return this.__typeOfRange.get(); }
        set typeOfRange(newValue) { this.__typeOfRange.set(newValue); }
        get useMinValue() { return this.__useMinValue.get(); }
        set useMinValue(newValue) { this.__useMinValue.set(newValue); }
        get useMaxValue() { return this.__useMaxValue.get(); }
        set useMaxValue(newValue) { this.__useMaxValue.set(newValue); }
        get minValue() { return this.__minValue.get(); }
        set minValue(newValue) { this.__minValue.set(newValue); }
        get maxValue() { return this.__maxValue.get(); }
        set maxValue(newValue) { this.__maxValue.set(newValue); }
        get minAttribute() { return this.__minAttribute.get(); }
        set minAttribute(newValue) { this.__minAttribute.set(newValue); }
        get minAttributeQualifiedName() { return this.__minAttribute.qualifiedName(); }
        get maxAttribute() { return this.__maxAttribute.get(); }
        set maxAttribute(newValue) { this.__maxAttribute.set(newValue); }
        get maxAttributeQualifiedName() { return this.__maxAttribute.qualifiedName(); }
        /**
    ...
    class RegExRuleInfo extends RuleInfo {
        ...
        get containerAsValidationRule() { return super.getContainerAs(ValidationRule); }
        get regularExpression() { return this.__regularExpression.get(); }
        set regularExpression(newValue) { this.__regularExpression.set(newValue); }
        get regularExpressionQualifiedName() { return this.__regularExpression.qualifiedName(); }
        /**
    ...
    class ValidationRule extends internal.Element {
        ...
        get ruleInfo() { return this.__ruleInfo.get(); }
        set ruleInfo(newValue) { this.__ruleInfo.set(newValue); }
        /**
