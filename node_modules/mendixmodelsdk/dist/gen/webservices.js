...
(function (webservices) {
    ...
    class DataMember extends internal.Element {
        ...
        get containerAsDataEntityBase() { return super.getContainerAs(DataEntityBase); }
        get containerAsPublishedParameter() { return super.getContainerAs(PublishedParameter); }
        get containerAsPublishedResource() { return super.getContainerAs(PublishedResource); }
        get isLockedByContract() { return this.__isLockedByContract.get(); }
        set isLockedByContract(newValue) { this.__isLockedByContract.set(newValue); }
        get exposedName() { return this.__exposedName.get(); }
        set exposedName(newValue) { this.__exposedName.set(newValue); }
        get isOptionalByContract() { return this.__isOptionalByContract.get(); }
        set isOptionalByContract(newValue) { this.__isOptionalByContract.set(newValue); }
        get isOptional() { return this.__isOptional.get(); }
        set isOptional(newValue) { this.__isOptional.set(newValue); }
        get isNillableByContract() { return this.__isNillableByContract.get(); }
        set isNillableByContract(newValue) { this.__isNillableByContract.set(newValue); }
        get isNillable() { return this.__isNillable.get(); }
        set isNillable(newValue) { this.__isNillable.set(newValue); }
    ...
    class DataEntityBase extends DataMember {
        ...
        get containerAsPublishedParameter() { return super.getContainerAs(PublishedParameter); }
        get containerAsPublishedResource() { return super.getContainerAs(PublishedResource); }
        get childMembers() { return this.__childMembers.get(); }
    ...
    class DataAssociation extends DataEntityBase {
        ...
        get containerAsDataEntityBase() { return super.getContainerAs(DataEntityBase); }
        get associationByContract() { return this.__associationByContract.get(); }
        set associationByContract(newValue) { this.__associationByContract.set(newValue); }
    ...
    class DataAttribute extends DataMember {
        ...
        get containerAsDataEntityBase() { return super.getContainerAs(DataEntityBase); }
        get attributeByContract() { return this.__attributeByContract.get(); }
        set attributeByContract(newValue) { this.__attributeByContract.set(newValue); }
    ...
    class ImportedWebService extends projects_1.projects.Document {
        ...
        get wsdlDescription() { return this.__wsdlDescription.get(); }
        set wsdlDescription(newValue) { this.__wsdlDescription.set(newValue); }
        get wsdlUrl() { return this.__wsdlUrl.get(); }
        set wsdlUrl(newValue) { this.__wsdlUrl.set(newValue); }
        /**
         * In version 6.4.1: introduced
         */
        get useMtom() { return this.__useMtom.get(); }
        set useMtom(newValue) { this.__useMtom.set(newValue); }
        /**
    ...
    class OperationInfo extends internal.Element {
        ...
        get containerAsServiceInfo() { return super.getContainerAs(ServiceInfo); }
        ...
        get soapAction() { return this.__soapAction.get(); }
        set soapAction(newValue) { this.__soapAction.set(newValue); }
        get requestHeaderRpcElement() { return this.__requestHeaderRpcElement.get(); }
        set requestHeaderRpcElement(newValue) { this.__requestHeaderRpcElement.set(newValue); }
        get requestBodyRpcElement() { return this.__requestBodyRpcElement.get(); }
        set requestBodyRpcElement(newValue) { this.__requestBodyRpcElement.set(newValue); }
        get responseBodyRpcElement() { return this.__responseBodyRpcElement.get(); }
        set responseBodyRpcElement(newValue) { this.__responseBodyRpcElement.set(newValue); }
        get requestHeaderElementName() { return this.__requestHeaderElementName.get(); }
        set requestHeaderElementName(newValue) { this.__requestHeaderElementName.set(newValue); }
        get requestHeaderEncoded() { return this.__requestHeaderEncoded.get(); }
        set requestHeaderEncoded(newValue) { this.__requestHeaderEncoded.set(newValue); }
        get requestHeaderPartEncoding() { return this.__requestHeaderPartEncoding.get(); }
        set requestHeaderPartEncoding(newValue) { this.__requestHeaderPartEncoding.set(newValue); }
        get requestBodyEncoded() { return this.__requestBodyEncoded.get(); }
        set requestBodyEncoded(newValue) { this.__requestBodyEncoded.set(newValue); }
        get requestBodyElementName() { return this.__requestBodyElementName.get(); }
        set requestBodyElementName(newValue) { this.__requestBodyElementName.set(newValue); }
        get requestBodyPartEncodings() { return this.__requestBodyPartEncodings.get(); }
        get responseBodyElementName() { return this.__responseBodyElementName.get(); }
        set responseBodyElementName(newValue) { this.__responseBodyElementName.set(newValue); }
        /**
         * In version 6.1.0: deleted
         */
        get allowSimpleMappingInheritance() { return this.__allowSimpleMappingInheritance.get(); }
        set allowSimpleMappingInheritance(newValue) { this.__allowSimpleMappingInheritance.set(newValue); }
        /**
    ...
    class PartEncoding extends internal.Element {
        ...
        get containerAsOperationInfo() { return super.getContainerAs(OperationInfo); }
        get partName() { return this.__partName.get(); }
        set partName(newValue) { this.__partName.set(newValue); }
        get partXsdType() { return this.__partXsdType.get(); }
        set partXsdType(newValue) { this.__partXsdType.set(newValue); }
        /**
    ...
    class PublishedServiceBase extends projects_1.projects.Document {
        ...
        get containerAsFolderBase() { return super.getContainerAs(projects_1.projects.FolderBase); }
        get versionedServices() { return this.__versionedServices.get(); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class PublishedResource extends internal.Element {
        ...
        get containerAsPublishedODataService() { return super.getContainerAs(rest_1.rest.PublishedODataService); }
        get containerAsVersionedService() { return super.getContainerAs(VersionedService); }
        get dataEntity() { return this.__dataEntity.get(); }
        set dataEntity(newValue) { this.__dataEntity.set(newValue); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    class PublishedOperation extends PublishedResource {
        ...
        get returnTypeNameByContract() { return this.__returnTypeNameByContract.get(); }
        set returnTypeNameByContract(newValue) { this.__returnTypeNameByContract.set(newValue); }
        get returnTypeSpecificationByContract() { return this.__returnTypeSpecificationByContract.get(); }
        set returnTypeSpecificationByContract(newValue) { this.__returnTypeSpecificationByContract.set(newValue); }
        get entityExposedNameByContract() { return this.__entityExposedNameByContract.get(); }
        set entityExposedNameByContract(newValue) { this.__entityExposedNameByContract.set(newValue); }
        get entityExposedName() { return this.__entityExposedName.get(); }
        set entityExposedName(newValue) { this.__entityExposedName.set(newValue); }
        /**
         ...
         */
        get operationReturnType() { return this.__operationReturnType.get(); }
        set operationReturnType(newValue) { this.__operationReturnType.set(newValue); }
        get returnTypeIsOptional() { return this.__returnTypeIsOptional.get(); }
        set returnTypeIsOptional(newValue) { this.__returnTypeIsOptional.set(newValue); }
        get returnTypeIsNillable() { return this.__returnTypeIsNillable.get(); }
        set returnTypeIsNillable(newValue) { this.__returnTypeIsNillable.set(newValue); }
        /**
    ...
    class PublishedParameter extends internal.Element {
        ...
        get containerAsPublishedOperation() { return super.getContainerAs(PublishedOperation); }
        get isLockedByContract() { return this.__isLockedByContract.get(); }
        set isLockedByContract(newValue) { this.__isLockedByContract.set(newValue); }
        ...
        get parameterByContract() { return this.__parameterByContract.get(); }
        set parameterByContract(newValue) { this.__parameterByContract.set(newValue); }
        get entityExposedName() { return this.__entityExposedName.get(); }
        set entityExposedName(newValue) { this.__entityExposedName.set(newValue); }
        get isOptionalByContract() { return this.__isOptionalByContract.get(); }
        set isOptionalByContract(newValue) { this.__isOptionalByContract.set(newValue); }
        ...
        get isNillable() { return this.__isNillable.get(); }
        set isNillable(newValue) { this.__isNillable.set(newValue); }
        get entityExposedItemNameByContract() { return this.__entityExposedItemNameByContract.get(); }
        set entityExposedItemNameByContract(newValue) { this.__entityExposedItemNameByContract.set(newValue); }
        get entityExposedItemName() { return this.__entityExposedItemName.get(); }
        set entityExposedItemName(newValue) { this.__entityExposedItemName.set(newValue); }
        /**
         * The value of this property is conceptually of type dataTypes.LegacyDataType.
         *
         * In version 7.9.0: deleted
    ...
    class RpcMessagePartElement extends internal.Element {
        ...
        get containerAsRpcOperationElement() { return super.getContainerAs(RpcOperationElement); }
        get partName() { return this.__partName.get(); }
        set partName(newValue) { this.__partName.set(newValue); }
        get typeName() { return this.__typeName.get(); }
        set typeName(newValue) { this.__typeName.set(newValue); }
        get elementName() { return this.__elementName.get(); }
        set elementName(newValue) { this.__elementName.set(newValue); }
        /**
    ...
    class RpcOperationElement extends internal.Element {
        ...
        get name() { return this.__name.get(); }
        set name(newValue) { this.__name.set(newValue); }
        get messagePartElements() { return this.__messagePartElements.get(); }
        /**
    ...
    class ServiceInfo extends internal.Element {
        ...
        get containerAsWsdlDescription() { return super.getContainerAs(WsdlDescription); }
        get name() { return this.__name.get(); }
        set name(newValue) { this.__name.set(newValue); }
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
        get portName() { return this.__portName.get(); }
        set portName(newValue) { this.__portName.set(newValue); }
        get location() { return this.__location.get(); }
        set location(newValue) { this.__location.set(newValue); }
        get soapVersion() { return this.__soapVersion.get(); }
        set soapVersion(newValue) { this.__soapVersion.set(newValue); }
        get locationConstant() { return this.__locationConstant.get(); }
        set locationConstant(newValue) { this.__locationConstant.set(newValue); }
        get locationConstantQualifiedName() { return this.__locationConstant.qualifiedName(); }
    ...
    class VersionedService extends internal.Element {
        ...
        get containerAsPublishedServiceBase() { return super.getContainerAs(PublishedServiceBase); }
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
        get targetNamespace() { return this.__targetNamespace.get(); }
        set targetNamespace(newValue) { this.__targetNamespace.set(newValue); }
        get headerAuthentication() { return this.__headerAuthentication.get(); }
        set headerAuthentication(newValue) { this.__headerAuthentication.set(newValue); }
        get operations() { return this.__operations.get(); }
        get isLockedByContract() { return this.__isLockedByContract.get(); }
        set isLockedByContract(newValue) { this.__isLockedByContract.set(newValue); }
        get enumerationsByContract() { return this.__enumerationsByContract.get(); }
        set enumerationsByContract(newValue) { this.__enumerationsByContract.set(newValue); }
        /**
         * In version 7.13.0: introduced
         */
        get optimizedXml() { return this.__optimizedXml.get(); }
        set optimizedXml(newValue) { this.__optimizedXml.set(newValue); }
        get headerImportMapping() { return this.__headerImportMapping.get(); }
        set headerImportMapping(newValue) { this.__headerImportMapping.set(newValue); }
        get headerImportMappingQualifiedName() { return this.__headerImportMapping.qualifiedName(); }
        get headerMicroflow() { return this.__headerMicroflow.get(); }
        set headerMicroflow(newValue) { this.__headerMicroflow.set(newValue); }
        get headerMicroflowQualifiedName() { return this.__headerMicroflow.qualifiedName(); }
        get versionNumber() { return this.__versionNumber.get(); }
        set versionNumber(newValue) { this.__versionNumber.set(newValue); }
        get caption() { return this.__caption.get(); }
        set caption(newValue) { this.__caption.set(newValue); }
        get description() { return this.__description.get(); }
        set description(newValue) { this.__description.set(newValue); }
        get appServiceState() { return this.__appServiceState.get(); }
        set appServiceState(newValue) { this.__appServiceState.set(newValue); }
        get image() { return this.__image.get(); }
        set image(newValue) { this.__image.set(newValue); }
        get imageQualifiedName() { return this.__image.qualifiedName(); }
        get validate() { return this.__validate.get(); }
        set validate(newValue) { this.__validate.set(newValue); }
        /**
    ...
    class WsdlDescription extends internal.Element {
        ...
        get containerAsMsd() { return super.getContainerAs(appservices_1.appservices.Msd); }
        get containerAsImportedWebService() { return super.getContainerAs(ImportedWebService); }
        get wsdlEntries() { return this.__wsdlEntries.get(); }
        get schemaEntries() { return this.__schemaEntries.get(); }
        get services() { return this.__services.get(); }
        get targetNamespace() { return this.__targetNamespace.get(); }
        set targetNamespace(newValue) { this.__targetNamespace.set(newValue); }
        get importsHaveLocations() { return this.__importsHaveLocations.get(); }
        set importsHaveLocations(newValue) { this.__importsHaveLocations.set(newValue); }
        /**
