...
(function (navigation) {
    ...
    class HomePageBase extends internal.Element {
        ...
        get containerAsNavigationProfile() { return super.getContainerAs(NavigationProfile); }
    ...
    class NavigationDocument extends projects_1.projects.ProjectDocument {
         ...
         */
        get profiles() { return this.__profiles.get(); }
        /**
         * In version 7.2.0: deleted
         */
        get phoneProfile() { return this.__phoneProfile.get(); }
        set phoneProfile(newValue) { this.__phoneProfile.set(newValue); }
        /**
         * In version 7.2.0: deleted
         */
        get tabletProfile() { return this.__tabletProfile.get(); }
        set tabletProfile(newValue) { this.__tabletProfile.set(newValue); }
        /**
         * In version 7.2.0: deleted
         */
        get desktopProfile() { return this.__desktopProfile.get(); }
        set desktopProfile(newValue) { this.__desktopProfile.set(newValue); }
        /**
         * In version 7.2.0: deleted
         * In version 7.0.2: introduced
         */
        get hybridTabletProfile() { return this.__hybridTabletProfile.get(); }
        set hybridTabletProfile(newValue) { this.__hybridTabletProfile.set(newValue); }
        /**
         * In version 7.2.0: deleted
         * In version 7.0.2: introduced
         */
        get hybridPhoneProfile() { return this.__hybridPhoneProfile.get(); }
        set hybridPhoneProfile(newValue) { this.__hybridPhoneProfile.set(newValue); }
        /**
         * In version 7.0.2: deleted
         */
        get offlinePhoneProfile() { return this.__offlinePhoneProfile.get(); }
        set offlinePhoneProfile(newValue) { this.__offlinePhoneProfile.set(newValue); }
        /**
         * In version 7.0.0: deleted
         * In version 6.10.4: introduced
         */
        get hybridPhoneProfile6() { return this.__hybridPhoneProfile6.get(); }
        set hybridPhoneProfile6(newValue) { this.__hybridPhoneProfile6.set(newValue); }
        /**
         * In version 7.0.0: deleted
         * In version 6.10.4: introduced
         */
        get hybridTabletProfile6() { return this.__hybridTabletProfile6.get(); }
        set hybridTabletProfile6(newValue) { this.__hybridTabletProfile6.set(newValue); }
        /**
        ...
        _initializeDefaultProperties() {
            ...
            if (this.__profiles.isAvailable) {
                this.profiles.replace([((navigationProfile) => {
     ...
     */
    class NavigationProfile extends internal.Element {
        constructor(model, structureTypeName, id, isPartial, unit, container) {
            super(model, structureTypeName, id, isPartial, unit, container);
            /** @internal */
            this.__name = new internal.PrimitiveProperty(NavigationProfile, this, "name", "", internal.PrimitiveTypeEnum.String);
            /** @internal */
        ...
        get containerAsNavigationDocument() { return super.getContainerAs(NavigationDocument); }
        /**
         * In version 7.2.0: introduced
         */
         ...
         * In version 7.2.0: introduced
         */
        get kind() { return this.__kind.get(); }
        set kind(newValue) { this.__kind.set(newValue); }
        /**
         * In version 7.2.0: deleted
         */
         ...
         * In version 7.0.2: introduced
         */
        get offlineEnabled() { return this.__offlineEnabled.get(); }
        set offlineEnabled(newValue) { this.__offlineEnabled.set(newValue); }
        get homePage() { return this.__homePage.get(); }
        set homePage(newValue) { this.__homePage.set(newValue); }
        get roleBasedHomePages() { return this.__roleBasedHomePages.get(); }
        get applicationTitle() { return this.__applicationTitle.get(); }
        set applicationTitle(newValue) { this.__applicationTitle.set(newValue); }
        /**
         * In version 7.0.2: introduced
         */
        get loginPageSettings() { return this.__loginPageSettings.get(); }
        set loginPageSettings(newValue) { this.__loginPageSettings.set(newValue); }
        get menuItemCollection() { return this.__menuItemCollection.get(); }
        set menuItemCollection(newValue) { this.__menuItemCollection.set(newValue); }
        /**
         * In version 7.0.0: deleted
         * In version 6.10.4: introduced
         */
        get offlineEnabled6() { return this.__offlineEnabled6.get(); }
        set offlineEnabled6(newValue) { this.__offlineEnabled6.set(newValue); }
        /**
    ...
    class RoleBasedHomePage extends HomePageBase {
        ...
        get containerAsNavigationProfile() { return super.getContainerAs(NavigationProfile); }
        get userRole() { return this.__userRole.get(); }
        set userRole(newValue) { this.__userRole.set(newValue); }
        get userRoleQualifiedName() { return this.__userRole.qualifiedName(); }
        /**
