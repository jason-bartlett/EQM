...
(function (microflows) {
    ...
    class MicroflowObject extends internal.Element {
        ...
        get containerAsMicroflowObjectCollection() { return super.getContainerAs(MicroflowObjectCollection); }
        get relativeMiddlePoint() { return this.__relativeMiddlePoint.get(); }
        set relativeMiddlePoint(newValue) { this.__relativeMiddlePoint.set(newValue); }
    ...
    class ActionActivity extends Activity {
        ...
        get autoGenerateCaption() { return this.__autoGenerateCaption.get(); }
        set autoGenerateCaption(newValue) { this.__autoGenerateCaption.set(newValue); }
        get backgroundColor() { return this.__backgroundColor.get(); }
        set backgroundColor(newValue) { this.__backgroundColor.set(newValue); }
    ...
    class RequestHandling extends internal.Element {
        ...
        get containerAsExportXmlAction() { return super.getContainerAs(ExportXmlAction); }
        get containerAsRestCallAction() { return super.getContainerAs(RestCallAction); }
        get containerAsWebServiceCallAction() { return super.getContainerAs(WebServiceCallAction); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class MicroflowAction extends internal.Element {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get errorHandlingType() { return this.__errorHandlingType.get(); }
        set errorHandlingType(newValue) { this.__errorHandlingType.set(newValue); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
    ...
    class AggregateListAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get inputListVariableName() { return this.__inputListVariableName.get(); }
        set inputListVariableName(newValue) { this.__inputListVariableName.set(newValue); }
    ...
    class Flow extends internal.Element {
        ...
        get containerAsMicroflowBase() { return super.getContainerAs(MicroflowBase); }
        get origin() { return this.__origin.get(); }
        set origin(newValue) { this.__origin.set(newValue); }
        get destination() { return this.__destination.get(); }
        set destination(newValue) { this.__destination.set(newValue); }
        get originConnectionIndex() { return this.__originConnectionIndex.get(); }
        set originConnectionIndex(newValue) { this.__originConnectionIndex.set(newValue); }
        get destinationConnectionIndex() { return this.__destinationConnectionIndex.get(); }
        set destinationConnectionIndex(newValue) { this.__destinationConnectionIndex.set(newValue); }
        get originBezierVector() { return this.__originBezierVector.get(); }
        set originBezierVector(newValue) { this.__originBezierVector.set(newValue); }
        get destinationBezierVector() { return this.__destinationBezierVector.get(); }
        set destinationBezierVector(newValue) { this.__destinationBezierVector.set(newValue); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class AppServiceCallAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get appServiceAction() { return this.__appServiceAction.get(); }
        set appServiceAction(newValue) { this.__appServiceAction.set(newValue); }
        get appServiceActionQualifiedName() { return this.__appServiceAction.qualifiedName(); }
        get parameterMappings() { return this.__parameterMappings.get(); }
        get useVariable() { return this.__useVariable.get(); }
        set useVariable(newValue) { this.__useVariable.set(newValue); }
        get outputVariableName() { return this.__outputVariableName.get(); }
        set outputVariableName(newValue) { this.__outputVariableName.set(newValue); }
        /**
    ...
    class AppServiceCallParameterMapping extends internal.Element {
        ...
        get containerAsAppServiceCallAction() { return super.getContainerAs(AppServiceCallAction); }
         ...
         */
        get argument() { return this.__argument.get(); }
        set argument(newValue) { this.__argument.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get argumentModel() { return this.__argumentModel.get(); }
        set argumentModel(newValue) { this.__argumentModel.set(newValue); }
        /**
    ...
    class RetrieveSource extends internal.Element {
        ...
        get containerAsRetrieveAction() { return super.getContainerAs(RetrieveAction); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class AssociationRetrieveSource extends RetrieveSource {
        ...
        get containerAsRetrieveAction() { return super.getContainerAs(RetrieveAction); }
        get startVariableName() { return this.__startVariableName.get(); }
        set startVariableName(newValue) { this.__startVariableName.set(newValue); }
    ...
    class JavaActionParameterValue extends internal.Element {
        ...
        get containerAsJavaActionParameterMapping() { return super.getContainerAs(JavaActionParameterMapping); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class BasicJavaActionParameterValue extends JavaActionParameterValue {
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, BasicJavaActionParameterValue.structureTypeName, { start: "6.7.0" });
    ...
    class ListOperation extends internal.Element {
        ...
        get containerAsListOperationAction() { return super.getContainerAs(ListOperationAction); }
        get listVariableName() { return this.__listVariableName.get(); }
        set listVariableName(newValue) { this.__listVariableName.set(newValue); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class BinaryListOperation extends ListOperation {
        ...
        get containerAsListOperationAction() { return super.getContainerAs(ListOperationAction); }
        get secondListOrObjectVariableName() { return this.__secondListOrObjectVariableName.get(); }
        set secondListOrObjectVariableName(newValue) { this.__secondListOrObjectVariableName.set(newValue); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class CaseValue extends internal.Element {
        ...
        get containerAsSequenceFlow() { return super.getContainerAs(SequenceFlow); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class ChangeListAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get changeVariableName() { return this.__changeVariableName.get(); }
        set changeVariableName(newValue) { this.__changeVariableName.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
    ...
    class ChangeMembersAction extends MicroflowAction {
        ...
        get refreshInClient() { return this.__refreshInClient.get(); }
        set refreshInClient(newValue) { this.__refreshInClient.set(newValue); }
    ...
    class CommitAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get withEvents() { return this.__withEvents.get(); }
        set withEvents(newValue) { this.__withEvents.set(newValue); }
        get commitVariableName() { return this.__commitVariableName.get(); }
        set commitVariableName(newValue) { this.__commitVariableName.set(newValue); }
        get refreshInClient() { return this.__refreshInClient.get(); }
        set refreshInClient(newValue) { this.__refreshInClient.set(newValue); }
        /**
    ...
    class Range extends internal.Element {
        ...
        get containerAsDatabaseRetrieveSource() { return super.getContainerAs(DatabaseRetrieveSource); }
        get containerAsImportMappingCall() { return super.getContainerAs(ImportMappingCall); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class ConstantRange extends Range {
        ...
        get containerAsDatabaseRetrieveSource() { return super.getContainerAs(DatabaseRetrieveSource); }
        get containerAsImportMappingCall() { return super.getContainerAs(ImportMappingCall); }
        get singleObject() { return this.__singleObject.get(); }
        set singleObject(newValue) { this.__singleObject.set(newValue); }
        /**
    ...
    class CreateVariableAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get variableName() { return this.__variableName.get(); }
        set variableName(newValue) { this.__variableName.set(newValue); }
        /**
         * The value of this property is conceptually of type dataTypes.LegacyDataType.
         *
         * In version 7.9.0: deleted
         */
        get variableDataType() { return this.__variableDataType.get(); }
        set variableDataType(newValue) { this.__variableDataType.set(newValue); }
        /**
         * In version 7.9.0: introduced
         */
        get variableType() { return this.__variableType.get(); }
        set variableType(newValue) { this.__variableType.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get initialValue() { return this.__initialValue.get(); }
        set initialValue(newValue) { this.__initialValue.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get initialValueModel() { return this.__initialValueModel.get(); }
        set initialValueModel(newValue) { this.__initialValueModel.set(newValue); }
        /**
    ...
    class CustomRange extends Range {
         ...
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get limitExpression() { return this.__limitExpression.get(); }
        set limitExpression(newValue) { this.__limitExpression.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get offsetExpression() { return this.__offsetExpression.get(); }
        set offsetExpression(newValue) { this.__offsetExpression.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get limitExpressionModel() { return this.__limitExpressionModel.get(); }
        set limitExpressionModel(newValue) { this.__limitExpressionModel.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get offsetExpressionModel() { return this.__offsetExpressionModel.get(); }
        set offsetExpressionModel(newValue) { this.__offsetExpressionModel.set(newValue); }
        /**
    ...
    class DatabaseRetrieveSource extends RetrieveSource {
        ...
        set entity(newValue) { this.__entity.set(newValue); }
        get entityQualifiedName() { return this.__entity.qualifiedName(); }
        get range() { return this.__range.get(); }
        set range(newValue) { this.__range.set(newValue); }
        /**
        ...
        get sortItemList() { return this.__sortItemList.get(); }
        set sortItemList(newValue) { this.__sortItemList.set(newValue); }
        /**
    ...
    class DeleteAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get deleteVariableName() { return this.__deleteVariableName.get(); }
        set deleteVariableName(newValue) { this.__deleteVariableName.set(newValue); }
        get refreshInClient() { return this.__refreshInClient.get(); }
        set refreshInClient(newValue) { this.__refreshInClient.set(newValue); }
        /**
    ...
    class DocumentTemplateParameterMapping extends internal.Element {
        ...
        get containerAsGenerateDocumentAction() { return super.getContainerAs(GenerateDocumentAction); }
    ...
    class DownloadFileAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get fileDocumentVariableName() { return this.__fileDocumentVariableName.get(); }
        set fileDocumentVariableName(newValue) { this.__fileDocumentVariableName.set(newValue); }
    ...
    class EndEvent extends MicroflowObject {
         ...
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get returnValue() { return this.__returnValue.get(); }
        set returnValue(newValue) { this.__returnValue.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get returnValueModel() { return this.__returnValueModel.get(); }
        set returnValueModel(newValue) { this.__returnValueModel.set(newValue); }
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
        /**
    ...
    class EntityTypeJavaActionParameterValue extends JavaActionParameterValue {
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, EntityTypeJavaActionParameterValue.structureTypeName, { start: "6.8.0" });
    ...
    class ExclusiveSplit extends MicroflowObject {
        ...
        get containerAsMicroflowObjectCollection() { return super.getContainerAs(MicroflowObjectCollection); }
        get splitCondition() { return this.__splitCondition.get(); }
        set splitCondition(newValue) { this.__splitCondition.set(newValue); }
        get caption() { return this.__caption.get(); }
        set caption(newValue) { this.__caption.set(newValue); }
        get errorHandlingType() { return this.__errorHandlingType.get(); }
        set errorHandlingType(newValue) { this.__errorHandlingType.set(newValue); }
    ...
    class ExportMappingJavaActionParameterValue extends JavaActionParameterValue {
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, ExportMappingJavaActionParameterValue.structureTypeName, { start: "7.2.0" });
    ...
    class ExportXmlAction extends MicroflowAction {
         ...
         */
        get mapping() { return this.__mapping.get(); }
        set mapping(newValue) { this.__mapping.set(newValue); }
        get mappingQualifiedName() { return this.__mapping.qualifiedName(); }
        /**
         * In version 7.6.0: deleted
         */
        get mappingArgumentVariableName() { return this.__mappingArgumentVariableName.get(); }
        set mappingArgumentVariableName(newValue) { this.__mappingArgumentVariableName.set(newValue); }
        /**
         * In version 7.6.0: introduced
         */
        get resultHandling() { return this.__resultHandling.get(); }
        set resultHandling(newValue) { this.__resultHandling.set(newValue); }
        get outputMethod() { return this.__outputMethod.get(); }
        set outputMethod(newValue) { this.__outputMethod.set(newValue); }
        get isValidationRequired() { return this.__isValidationRequired.get(); }
        set isValidationRequired(newValue) { this.__isValidationRequired.set(newValue); }
        /**
    ...
    class SplitCondition extends internal.Element {
        ...
        get containerAsExclusiveSplit() { return super.getContainerAs(ExclusiveSplit); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class FileDocumentExport extends OutputMethod {
        ...
        get containerAsExportXmlAction() { return super.getContainerAs(ExportXmlAction); }
        get targetDocumentVariableName() { return this.__targetDocumentVariableName.get(); }
        set targetDocumentVariableName(newValue) { this.__targetDocumentVariableName.set(newValue); }
        /**
    ...
    class GenerateDocumentAction extends MicroflowAction {
        ...
        get languageVariableName() { return this.__languageVariableName.get(); }
        set languageVariableName(newValue) { this.__languageVariableName.set(newValue); }
        get documentType() { return this.__documentType.get(); }
        set documentType(newValue) { this.__documentType.set(newValue); }
        get languageSetting() { return this.__languageSetting.get(); }
        set languageSetting(newValue) { this.__languageSetting.set(newValue); }
        get documentTemplate() { return this.__documentTemplate.get(); }
        set documentTemplate(newValue) { this.__documentTemplate.set(newValue); }
        get documentTemplateQualifiedName() { return this.__documentTemplate.qualifiedName(); }
        get parameterMappings() { return this.__parameterMappings.get(); }
        get overrideTopMargin() { return this.__overrideTopMargin.get(); }
        set overrideTopMargin(newValue) { this.__overrideTopMargin.set(newValue); }
        get overrideBottomMargin() { return this.__overrideBottomMargin.get(); }
        set overrideBottomMargin(newValue) { this.__overrideBottomMargin.set(newValue); }
        get overrideLeftMargin() { return this.__overrideLeftMargin.get(); }
        set overrideLeftMargin(newValue) { this.__overrideLeftMargin.set(newValue); }
        get overrideRightMargin() { return this.__overrideRightMargin.get(); }
        set overrideRightMargin(newValue) { this.__overrideRightMargin.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get marginLeftInInch() { return this.__marginLeftInInch.get(); }
        set marginLeftInInch(newValue) { this.__marginLeftInInch.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get marginLeftInInchModel() { return this.__marginLeftInInchModel.get(); }
        set marginLeftInInchModel(newValue) { this.__marginLeftInInchModel.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get marginRightInInch() { return this.__marginRightInInch.get(); }
        set marginRightInInch(newValue) { this.__marginRightInInch.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get marginRightInInchModel() { return this.__marginRightInInchModel.get(); }
        set marginRightInInchModel(newValue) { this.__marginRightInInchModel.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get marginTopInInch() { return this.__marginTopInInch.get(); }
        set marginTopInInch(newValue) { this.__marginTopInInch.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get marginTopInInchModel() { return this.__marginTopInInchModel.get(); }
        set marginTopInInchModel(newValue) { this.__marginTopInInchModel.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get marginBottomInInch() { return this.__marginBottomInInch.get(); }
        set marginBottomInInch(newValue) { this.__marginBottomInInch.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get marginBottomInInchModel() { return this.__marginBottomInInchModel.get(); }
        set marginBottomInInchModel(newValue) { this.__marginBottomInInchModel.set(newValue); }
        /**
    ...
    class HttpConfiguration extends internal.Element {
        ...
        get containerAsRestCallAction() { return super.getContainerAs(RestCallAction); }
        get containerAsWebServiceCallAction() { return super.getContainerAs(WebServiceCallAction); }
        get overrideLocation() { return this.__overrideLocation.get(); }
        set overrideLocation(newValue) { this.__overrideLocation.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get customLocation() { return this.__customLocation.get(); }
        set customLocation(newValue) { this.__customLocation.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get customLocationModel() { return this.__customLocationModel.get(); }
        set customLocationModel(newValue) { this.__customLocationModel.set(newValue); }
        /**
         * In version 6.6.0: introduced
         */
        get customLocationTemplate() { return this.__customLocationTemplate.get(); }
        set customLocationTemplate(newValue) { this.__customLocationTemplate.set(newValue); }
        get useAuthentication() { return this.__useAuthentication.get(); }
        set useAuthentication(newValue) { this.__useAuthentication.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get httpAuthenticationUserName() { return this.__httpAuthenticationUserName.get(); }
        set httpAuthenticationUserName(newValue) { this.__httpAuthenticationUserName.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         ...
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get authenticationPassword() { return this.__authenticationPassword.get(); }
        set authenticationPassword(newValue) { this.__authenticationPassword.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
        ...
        get headerEntries() { return this.__headerEntries.get(); }
        /**
         ...
         */
        get newHttpMethod() { return this.__newHttpMethod.get(); }
        set newHttpMethod(newValue) { this.__newHttpMethod.set(newValue); }
        /**
    ...
    class HttpHeaderEntry extends internal.Element {
        ...
        get containerAsHttpConfiguration() { return super.getContainerAs(HttpConfiguration); }
    ...
    class ImportMappingCall extends internal.Element {
        ...
        get containerAsResultHandling() { return super.getContainerAs(ResultHandling); }
        get mapping() { return this.__mapping.get(); }
        set mapping(newValue) { this.__mapping.set(newValue); }
        get mappingQualifiedName() { return this.__mapping.qualifiedName(); }
        get mappingArgumentVariableName() { return this.__mappingArgumentVariableName.get(); }
         ...
         * In version 7.6.0: introduced
         */
        get contentType() { return this.__contentType.get(); }
        set contentType(newValue) { this.__contentType.set(newValue); }
        /**
         * In version 7.8.0: introduced
         */
        get forceSingleOccurrence() { return this.__forceSingleOccurrence.get(); }
        set forceSingleOccurrence(newValue) { this.__forceSingleOccurrence.set(newValue); }
        /**
    ...
    class ImportMappingJavaActionParameterValue extends JavaActionParameterValue {
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, ImportMappingJavaActionParameterValue.structureTypeName, { start: "7.2.0" });
    ...
    class ImportXmlAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get xmlDocumentVariableName() { return this.__xmlDocumentVariableName.get(); }
        set xmlDocumentVariableName(newValue) { this.__xmlDocumentVariableName.set(newValue); }
        get resultHandling() { return this.__resultHandling.get(); }
        set resultHandling(newValue) { this.__resultHandling.set(newValue); }
        get isValidationRequired() { return this.__isValidationRequired.get(); }
        set isValidationRequired(newValue) { this.__isValidationRequired.set(newValue); }
    ...
    class InheritanceSplit extends MicroflowObject {
        ...
        get containerAsMicroflowObjectCollection() { return super.getContainerAs(MicroflowObjectCollection); }
        get splitVariableName() { return this.__splitVariableName.get(); }
        set splitVariableName(newValue) { this.__splitVariableName.set(newValue); }
        get caption() { return this.__caption.get(); }
        set caption(newValue) { this.__caption.set(newValue); }
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
    ...
    class JavaActionCallAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get javaAction() { return this.__javaAction.get(); }
        set javaAction(newValue) { this.__javaAction.set(newValue); }
        get javaActionQualifiedName() { return this.__javaAction.qualifiedName(); }
        get parameterMappings() { return this.__parameterMappings.get(); }
        /**
         * In version 7.13.0: introduced
         */
        get useReturnVariable() { return this.__useReturnVariable.get(); }
        set useReturnVariable(newValue) { this.__useReturnVariable.set(newValue); }
        get outputVariableName() { return this.__outputVariableName.get(); }
        set outputVariableName(newValue) { this.__outputVariableName.set(newValue); }
        /**
    ...
    class JavaActionParameterMapping extends internal.Element {
        ...
        get containerAsJavaActionCallAction() { return super.getContainerAs(JavaActionCallAction); }
        get parameter() { return this.__parameter.get(); }
        set parameter(newValue) { this.__parameter.set(newValue); }
        get parameterQualifiedName() { return this.__parameter.qualifiedName(); }
        /**
    ...
    class LogMessageAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get level() { return this.__level.get(); }
        set level(newValue) { this.__level.set(newValue); }
        /**
         * The value of this property is conceptually of type microflowExpressions.MicroflowExpression.
         */
        get node() { return this.__node.get(); }
        set node(newValue) { this.__node.set(newValue); }
        /**
         * NOTE: This property is experimental and is subject to change in newer Model SDK versions.
         *
         * In version 7.9.0: introduced
         */
        get nodeModel() { return this.__nodeModel.get(); }
        set nodeModel(newValue) { this.__nodeModel.set(newValue); }
        get messageTemplate() { return this.__messageTemplate.get(); }
        set messageTemplate(newValue) { this.__messageTemplate.set(newValue); }
        get includeLatestStackTrace() { return this.__includeLatestStackTrace.get(); }
        set includeLatestStackTrace(newValue) { this.__includeLatestStackTrace.set(newValue); }
        /**
    ...
    class LoopedActivity extends Activity {
        ...
        get containerAsMicroflowObjectCollection() { return super.getContainerAs(MicroflowObjectCollection); }
        get objectCollection() { return this.__objectCollection.get(); }
        set objectCollection(newValue) { this.__objectCollection.set(newValue); }
        get iteratedListVariableName() { return this.__iteratedListVariableName.get(); }
        set iteratedListVariableName(newValue) { this.__iteratedListVariableName.set(newValue); }
        get loopVariableName() { return this.__loopVariableName.get(); }
        set loopVariableName(newValue) { this.__loopVariableName.set(newValue); }
        get errorHandlingType() { return this.__errorHandlingType.get(); }
        set errorHandlingType(newValue) { this.__errorHandlingType.set(newValue); }
        get documentation() { return this.__documentation.get(); }
        set documentation(newValue) { this.__documentation.set(newValue); }
    ...
    class MemberChange extends internal.Element {
        ...
        get containerAsChangeMembersAction() { return super.getContainerAs(ChangeMembersAction); }
        get attribute() { return this.__attribute.get(); }
        set attribute(newValue) { this.__attribute.set(newValue); }
        get attributeQualifiedName() { return this.__attribute.qualifiedName(); }
        get association() { return this.__association.get(); }
    ...
    class MicroflowBase extends projects_1.projects.Document {
        ...
        get objectCollection() { return this.__objectCollection.get(); }
        set objectCollection(newValue) { this.__objectCollection.set(newValue); }
        get flows() { return this.__flows.get(); }
        /**
         * The value of this property is conceptually of type dataTypes.LegacyDataType.
         *
         * In version 7.9.0: deleted
         */
        get returnType() { return this.__returnType.get(); }
        set returnType(newValue) { this.__returnType.set(newValue); }
        /**
         * In version 7.9.0: introduced
         */
        get microflowReturnType() { return this.__microflowReturnType.get(); }
        set microflowReturnType(newValue) { this.__microflowReturnType.set(newValue); }
    ...
    class ServerSideMicroflow extends MicroflowBase {
        ...
        get containerAsFolderBase() { return super.getContainerAs(projects_1.projects.FolderBase); }
        get applyEntityAccess() { return this.__applyEntityAccess.get(); }
        set applyEntityAccess(newValue) { this.__applyEntityAccess.set(newValue); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class Microflow extends ServerSideMicroflow {
        ...
        get allowConcurrentExecution() { return this.__allowConcurrentExecution.get(); }
        set allowConcurrentExecution(newValue) { this.__allowConcurrentExecution.set(newValue); }
        get concurrencyErrorMessage() { return this.__concurrencyErrorMessage.get(); }
        set concurrencyErrorMessage(newValue) { this.__concurrencyErrorMessage.set(newValue); }
        get concurrencyErrorMicroflow() { return this.__concurrencyErrorMicroflow.get(); }
        set concurrencyErrorMicroflow(newValue) { this.__concurrencyErrorMicroflow.set(newValue); }
        get concurrencyErrorMicroflowQualifiedName() { return this.__concurrencyErrorMicroflow.qualifiedName(); }
        /**
    ...
    class MicroflowCall extends internal.Element {
        ...
        get containerAsMicroflowCallAction() { return super.getContainerAs(MicroflowCallAction); }
    ...
    class MicroflowCallAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get microflowCall() { return this.__microflowCall.get(); }
        set microflowCall(newValue) { this.__microflowCall.set(newValue); }
        get useReturnVariable() { return this.__useReturnVariable.get(); }
        set useReturnVariable(newValue) { this.__useReturnVariable.set(newValue); }
        get outputVariableName() { return this.__outputVariableName.get(); }
        set outputVariableName(newValue) { this.__outputVariableName.set(newValue); }
    ...
    class MicroflowCallParameterMapping extends internal.Element {
        ...
        get containerAsMicroflowCall() { return super.getContainerAs(MicroflowCall); }
        get parameter() { return this.__parameter.get(); }
        set parameter(newValue) { this.__parameter.set(newValue); }
        get parameterQualifiedName() { return this.__parameter.qualifiedName(); }
        /**
    ...
    class MicroflowJavaActionParameterValue extends JavaActionParameterValue {
         ...
         */
        static createIn(container) {
            internal.createInVersionCheck(container.model, MicroflowJavaActionParameterValue.structureTypeName, { start: "6.9.0" });
    ...
    class MicroflowObjectCollection extends internal.Element {
        ...
        get containerAsLoopedActivity() { return super.getContainerAs(LoopedActivity); }
        get containerAsMicroflowBase() { return super.getContainerAs(MicroflowBase); }
        get objects() { return this.__objects.get(); }
        /**
    ...
    class MicroflowParameterBase extends internal.Element {
        ...
        get containerAsMicroflow() { return super.getContainerAs(Microflow); }
        get containerAsRule() { return super.getContainerAs(Rule); }
    ...
    class RestCallAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get httpConfiguration() { return this.__httpConfiguration.get(); }
        set httpConfiguration(newValue) { this.__httpConfiguration.set(newValue); }
        get requestHandling() { return this.__requestHandling.get(); }
        set requestHandling(newValue) { this.__requestHandling.set(newValue); }
        /**
         * In version 6.9.0: introduced
         */
        get requestHandlingType() { return this.__requestHandlingType.get(); }
        set requestHandlingType(newValue) { this.__requestHandlingType.set(newValue); }
        get resultHandling() { return this.__resultHandling.get(); }
        set resultHandling(newValue) { this.__resultHandling.set(newValue); }
        /**
         * In version 6.9.0: introduced
         */
        get resultHandlingType() { return this.__resultHandlingType.get(); }
        set resultHandlingType(newValue) { this.__resultHandlingType.set(newValue); }
        /**
         * In version 7.0.2: introduced
         */
        get errorResultHandlingType() { return this.__errorResultHandlingType.get(); }
        set errorResultHandlingType(newValue) { this.__errorResultHandlingType.set(newValue); }
        /**
         * In version 7.1.0: introduced
         */
        get useRequestTimeOut() { return this.__useRequestTimeOut.get(); }
        set useRequestTimeOut(newValue) { this.__useRequestTimeOut.set(newValue); }
        /**
         * In version 7.1.0: introduced
         */
        get timeOut() { return this.__timeOut.get(); }
        set timeOut(newValue) { this.__timeOut.set(newValue); }
        /**
    ...
    class ResultHandling extends internal.Element {
        ...
        get containerAsImportXmlAction() { return super.getContainerAs(ImportXmlAction); }
        get containerAsRestCallAction() { return super.getContainerAs(RestCallAction); }
        get containerAsWebServiceCallAction() { return super.getContainerAs(WebServiceCallAction); }
        get importMappingCall() { return this.__importMappingCall.get(); }
        set importMappingCall(newValue) { this.__importMappingCall.set(newValue); }
        get storeInVariable() { return this.__storeInVariable.get(); }
        set storeInVariable(newValue) { this.__storeInVariable.set(newValue); }
        get outputVariableName() { return this.__outputVariableName.get(); }
        set outputVariableName(newValue) { this.__outputVariableName.set(newValue); }
        /**
         * The value of this property is conceptually of type dataTypes.LegacyDataType.
    ...
    class RetrieveAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get retrieveSource() { return this.__retrieveSource.get(); }
        set retrieveSource(newValue) { this.__retrieveSource.set(newValue); }
        get outputVariableName() { return this.__outputVariableName.get(); }
        set outputVariableName(newValue) { this.__outputVariableName.set(newValue); }
        /**
    ...
    class RollbackAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get rollbackVariableName() { return this.__rollbackVariableName.get(); }
        set rollbackVariableName(newValue) { this.__rollbackVariableName.set(newValue); }
        get refreshInClient() { return this.__refreshInClient.get(); }
        set refreshInClient(newValue) { this.__refreshInClient.set(newValue); }
        /**
    ...
    class RuleCall extends internal.Element {
        ...
        get containerAsRuleSplitCondition() { return super.getContainerAs(RuleSplitCondition); }
        get rule() { return this.__rule.get(); }
        set rule(newValue) { this.__rule.set(newValue); }
        get ruleQualifiedName() { return this.__rule.qualifiedName(); }
        get parameterMappings() { return this.__parameterMappings.get(); }
        /**
    ...
    class RuleCallParameterMapping extends internal.Element {
        ...
        get containerAsRuleCall() { return super.getContainerAs(RuleCall); }
        get parameter() { return this.__parameter.get(); }
        set parameter(newValue) { this.__parameter.set(newValue); }
        get parameterQualifiedName() { return this.__parameter.qualifiedName(); }
        /**
    ...
    class RuleSplitCondition extends SplitCondition {
        ...
        get containerAsExclusiveSplit() { return super.getContainerAs(ExclusiveSplit); }
        get ruleCall() { return this.__ruleCall.get(); }
        set ruleCall(newValue) { this.__ruleCall.set(newValue); }
        /**
    ...
    class SequenceFlow extends Flow {
        ...
        get containerAsMicroflowBase() { return super.getContainerAs(MicroflowBase); }
        get caseValue() { return this.__caseValue.get(); }
        set caseValue(newValue) { this.__caseValue.set(newValue); }
        get isErrorHandler() { return this.__isErrorHandler.get(); }
        set isErrorHandler(newValue) { this.__isErrorHandler.set(newValue); }
        /**
    ...
    class ShowMessageAction extends MicroflowAction {
        ...
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get blocking() { return this.__blocking.get(); }
        set blocking(newValue) { this.__blocking.set(newValue); }
        /**
    ...
    class ShowPageAction extends MicroflowAction {
        ...
        get passedObjectVariableName() { return this.__passedObjectVariableName.get(); }
        set passedObjectVariableName(newValue) { this.__passedObjectVariableName.set(newValue); }
        /**
    ...
    class SortItem extends internal.Element {
        ...
        get containerAsSortItemList() { return super.getContainerAs(SortItemList); }
        /**
        ...
        get sortOrder() { return this.__sortOrder.get(); }
        set sortOrder(newValue) { this.__sortOrder.set(newValue); }
        /**
    ...
    class SortItemList extends internal.Element {
        ...
        get containerAsDatabaseRetrieveSource() { return super.getContainerAs(DatabaseRetrieveSource); }
        get containerAsSort() { return super.getContainerAs(Sort); }
        get items() { return this.__items.get(); }
        /**
    ...
    class Template extends internal.Element {
        ...
        get containerAsCustomRequestHandling() { return super.getContainerAs(CustomRequestHandling); }
        get containerAsHttpConfiguration() { return super.getContainerAs(HttpConfiguration); }
        get containerAsLogMessageAction() { return super.getContainerAs(LogMessageAction); }
        get containerAsShowMessageAction() { return super.getContainerAs(ShowMessageAction); }
        get containerAsValidationFeedbackAction() { return super.getContainerAs(ValidationFeedbackAction); }
    ...
    class ValidationFeedbackAction extends MicroflowAction {
        ...
        get containerAsActionActivity() { return super.getContainerAs(ActionActivity); }
        get feedbackTemplate() { return this.__feedbackTemplate.get(); }
        set feedbackTemplate(newValue) { this.__feedbackTemplate.set(newValue); }
        get objectVariableName() { return this.__objectVariableName.get(); }
        set objectVariableName(newValue) { this.__objectVariableName.set(newValue); }
        /**
    ...
    class WebServiceCallAction extends MicroflowAction {
         ...
         * In version 6.7.0: deleted
         */
        get sendNullValueChoice() { return this.__sendNullValueChoice.get(); }
        set sendNullValueChoice(newValue) { this.__sendNullValueChoice.set(newValue); }
        get requestHeaderHandling() { return this.__requestHeaderHandling.get(); }
        set requestHeaderHandling(newValue) { this.__requestHeaderHandling.set(newValue); }
        get requestBodyHandling() { return this.__requestBodyHandling.get(); }
        set requestBodyHandling(newValue) { this.__requestBodyHandling.set(newValue); }
        get resultHandling() { return this.__resultHandling.get(); }
        set resultHandling(newValue) { this.__resultHandling.set(newValue); }
        get httpConfiguration() { return this.__httpConfiguration.get(); }
        set httpConfiguration(newValue) { this.__httpConfiguration.set(newValue); }
    ...
    class WebServiceOperationParameterMapping extends internal.Element {
        ...
        get containerAsAdvancedRequestHandling() { return super.getContainerAs(AdvancedRequestHandling); }
        get containerAsSimpleRequestHandling() { return super.getContainerAs(SimpleRequestHandling); }
        get isChecked() { return this.__isChecked.get(); }
        set isChecked(newValue) { this.__isChecked.set(newValue); }
    ...
    class WebServiceOperationSimpleParameterMapping extends WebServiceOperationParameterMapping {
         ...
         */
        get parameterPath() { return this.__parameterPath.get(); }
        set parameterPath(newValue) { this.__parameterPath.set(newValue); }
        /**
