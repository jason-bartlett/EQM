...
(function (settings) {
    ...
    class Certificate extends internal.Element {
        ...
        get containerAsCertificateSettings() { return super.getContainerAs(CertificateSettings); }
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get data() { return this.__data.get(); }
        set data(newValue) { this.__data.set(newValue); }
        /**
    ...
    class ProjectSettingsPart extends internal.Element {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        /** @internal */
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
        }
    ...
    class CertificateSettings extends ProjectSettingsPart {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        get certificates() { return this.__certificates.get(); }
        /**
    ...
    class Configuration extends internal.Element {
        ...
        get containerAsConfigurationSettings() { return super.getContainerAs(ConfigurationSettings); }
        get name() { return this.__name.get(); }
        set name(newValue) { this.__name.set(newValue); }
        get applicationRootUrl() { return this.__applicationRootUrl.get(); }
        set applicationRootUrl(newValue) { this.__applicationRootUrl.set(newValue); }
        get runtimePortNumber() { return this.__runtimePortNumber.get(); }
        set runtimePortNumber(newValue) { this.__runtimePortNumber.set(newValue); }
        get adminPortNumber() { return this.__adminPortNumber.get(); }
        set adminPortNumber(newValue) { this.__adminPortNumber.set(newValue); }
        get runtimePortOnlyLocal() { return this.__runtimePortOnlyLocal.get(); }
        set runtimePortOnlyLocal(newValue) { this.__runtimePortOnlyLocal.set(newValue); }
        get adminPortOnlyLocal() { return this.__adminPortOnlyLocal.get(); }
        set adminPortOnlyLocal(newValue) { this.__adminPortOnlyLocal.set(newValue); }
        get maxJavaHeapSize() { return this.__maxJavaHeapSize.get(); }
        set maxJavaHeapSize(newValue) { this.__maxJavaHeapSize.set(newValue); }
        get emulateCloudSecurity() { return this.__emulateCloudSecurity.get(); }
        set emulateCloudSecurity(newValue) { this.__emulateCloudSecurity.set(newValue); }
        get extraJvmParameters() { return this.__extraJvmParameters.get(); }
        set extraJvmParameters(newValue) { this.__extraJvmParameters.set(newValue); }
        get databaseType() { return this.__databaseType.get(); }
        set databaseType(newValue) { this.__databaseType.set(newValue); }
        get databaseUrl() { return this.__databaseUrl.get(); }
        set databaseUrl(newValue) { this.__databaseUrl.set(newValue); }
        get databaseName() { return this.__databaseName.get(); }
        set databaseName(newValue) { this.__databaseName.set(newValue); }
        get databaseUseIntegratedSecurity() { return this.__databaseUseIntegratedSecurity.get(); }
        set databaseUseIntegratedSecurity(newValue) { this.__databaseUseIntegratedSecurity.set(newValue); }
        get databaseUserName() { return this.__databaseUserName.get(); }
        set databaseUserName(newValue) { this.__databaseUserName.set(newValue); }
        get databasePassword() { return this.__databasePassword.get(); }
        set databasePassword(newValue) { this.__databasePassword.set(newValue); }
        get customSettings() { return this.__customSettings.get(); }
        get constantValues() { return this.__constantValues.get(); }
        /**
    ...
    class ConfigurationSettings extends ProjectSettingsPart {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        get configurations() { return this.__configurations.get(); }
        /**
        ...
        _initializeDefaultProperties() {
            super._initializeDefaultProperties();
            this.configurations.replace([((configuration) => {
    ...
    class ConstantValue extends internal.Element {
        ...
        get containerAsConfiguration() { return super.getContainerAs(Configuration); }
        get constant() { return this.__constant.get(); }
        set constant(newValue) { this.__constant.set(newValue); }
        get constantQualifiedName() { return this.__constant.qualifiedName(); }
    ...
    class JavaActionsSettings extends ProjectSettingsPart {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        get generatePostfixesForParameters() { return this.__generatePostfixesForParameters.get(); }
        set generatePostfixesForParameters(newValue) { this.__generatePostfixesForParameters.set(newValue); }
        /**
    ...
    class Language extends internal.Element {
        ...
        get containerAsLanguageSettings() { return super.getContainerAs(LanguageSettings); }
        get code() { return this.__code.get(); }
        set code(newValue) { this.__code.set(newValue); }
        get checkCompleteness() { return this.__checkCompleteness.get(); }
        set checkCompleteness(newValue) { this.__checkCompleteness.set(newValue); }
        ...
        get customTimeFormat() { return this.__customTimeFormat.get(); }
        set customTimeFormat(newValue) { this.__customTimeFormat.set(newValue); }
        get customDateTimeFormat() { return this.__customDateTimeFormat.get(); }
        set customDateTimeFormat(newValue) { this.__customDateTimeFormat.set(newValue); }
        /**
    ...
    class LanguageSettings extends ProjectSettingsPart {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        get defaultLanguageCode() { return this.__defaultLanguageCode.get(); }
        set defaultLanguageCode(newValue) { this.__defaultLanguageCode.set(newValue); }
        get languages() { return this.__languages.get(); }
        /**
        ...
        _initializeDefaultProperties() {
            ...
            this.languages.replace([((language) => {
                    language.code = "en_US";
                    return language;
    ...
    class ModelerSettings extends ProjectSettingsPart {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        get lowerCaseMicroflowVariables() { return this.__lowerCaseMicroflowVariables.get(); }
        set lowerCaseMicroflowVariables(newValue) { this.__lowerCaseMicroflowVariables.set(newValue); }
        /**
    ...
    class ProjectSettings extends projects_1.projects.ProjectDocument {
        ...
        get settingsParts() { return this.__settingsParts.get(); }
        /**
    ...
    class RuntimeSettings extends ProjectSettingsPart {
        ...
        get containerAsProjectSettings() { return super.getContainerAs(ProjectSettings); }
        get afterStartupMicroflow() { return this.__afterStartupMicroflow.get(); }
        set afterStartupMicroflow(newValue) { this.__afterStartupMicroflow.set(newValue); }
        get afterStartupMicroflowQualifiedName() { return this.__afterStartupMicroflow.qualifiedName(); }
        get beforeShutdownMicroflow() { return this.__beforeShutdownMicroflow.get(); }
        set beforeShutdownMicroflow(newValue) { this.__beforeShutdownMicroflow.set(newValue); }
        get beforeShutdownMicroflowQualifiedName() { return this.__beforeShutdownMicroflow.qualifiedName(); }
        get healthCheckMicroflow() { return this.__healthCheckMicroflow.get(); }
        set healthCheckMicroflow(newValue) { this.__healthCheckMicroflow.set(newValue); }
        get healthCheckMicroflowQualifiedName() { return this.__healthCheckMicroflow.qualifiedName(); }
        get firstDayOfWeek() { return this.__firstDayOfWeek.get(); }
        set firstDayOfWeek(newValue) { this.__firstDayOfWeek.set(newValue); }
        get defaultTimeZoneCode() { return this.__defaultTimeZoneCode.get(); }
        set defaultTimeZoneCode(newValue) { this.__defaultTimeZoneCode.set(newValue); }
        get scheduledEventTimeZoneCode() { return this.__scheduledEventTimeZoneCode.get(); }
        set scheduledEventTimeZoneCode(newValue) { this.__scheduledEventTimeZoneCode.set(newValue); }
        get hashAlgorithm() { return this.__hashAlgorithm.get(); }
        set hashAlgorithm(newValue) { this.__hashAlgorithm.set(newValue); }
        get roundingMode() { return this.__roundingMode.get(); }
        set roundingMode(newValue) { this.__roundingMode.set(newValue); }
        get allowUserMultipleSessions() { return this.__allowUserMultipleSessions.get(); }
        set allowUserMultipleSessions(newValue) { this.__allowUserMultipleSessions.set(newValue); }
        /**
         * In version 7.1.0: introduced
         */
        get enforceDataStorageUniqueness() { return this.__enforceDataStorageUniqueness.get(); }
        set enforceDataStorageUniqueness(newValue) { this.__enforceDataStorageUniqueness.set(newValue); }
        /**
         * In version 7.5.0: introduced
         */
        get enableDataStorageOptimisticLocking() { return this.__enableDataStorageOptimisticLocking.get(); }
        set enableDataStorageOptimisticLocking(newValue) { this.__enableDataStorageOptimisticLocking.set(newValue); }
        /**
         * In version 7.10.0: introduced
         */
        get enableDataStorageNewQueryHandling() { return this.__enableDataStorageNewQueryHandling.get(); }
        set enableDataStorageNewQueryHandling(newValue) { this.__enableDataStorageNewQueryHandling.set(newValue); }
        /**
    ...
    class WebUIProjectSettingsPart extends ProjectSettingsPart {
        ...
        set theme(newValue) { this.__theme.set(newValue); }
        /**
         * In version 7.9.0: introduced
         */
        get themeModuleName() { return this.__themeModuleName.get(); }
        set themeModuleName(newValue) { this.__themeModuleName.set(newValue); }
        /**
         * In version 6.2.0: deleted
         */
        get feedbackWidgetUpdated() { return this.__feedbackWidgetUpdated.get(); }
        set feedbackWidgetUpdated(newValue) { this.__feedbackWidgetUpdated.set(newValue); }
        get enableWidgetBundling() { return this.__enableWidgetBundling.get(); }
        set enableWidgetBundling(newValue) { this.__enableWidgetBundling.set(newValue); }
        /**
         * In version 6.6.0: introduced
         */
        get enableDownloadResources() { return this.__enableDownloadResources.get(); }
        set enableDownloadResources(newValue) { this.__enableDownloadResources.set(newValue); }
        /**
         * In version 7.0.2: introduced
         */
        get enableMicroflowReachabilityAnalysis() { return this.__enableMicroflowReachabilityAnalysis.get(); }
        set enableMicroflowReachabilityAnalysis(newValue) { this.__enableMicroflowReachabilityAnalysis.set(newValue); }
        /**
