...
(function (documenttemplates) {
    ...
    class Widget extends internal.Element {
        ...
        get containerAsDocumentTemplate() { return super.getContainerAs(DocumentTemplate); }
        get containerAsDropZone() { return super.getContainerAs(DropZone); }
    ...
    class Grid extends EntityWidget {
        ...
        get containerAsDocumentTemplate() { return super.getContainerAs(DocumentTemplate); }
        get containerAsDropZone() { return super.getContainerAs(DropZone); }
        get cellSpacing() { return this.__cellSpacing.get(); }
        set cellSpacing(newValue) { this.__cellSpacing.set(newValue); }
        get cellPadding() { return this.__cellPadding.get(); }
        set cellPadding(newValue) { this.__cellPadding.set(newValue); }
    ...
    class DataGrid extends Grid {
        ...
        get weights() { return this.__weights.get(); }
        /**
    ...
    class DataGridCell extends internal.Element {
        ...
        get containerAsDataGridColumn() { return super.getContainerAs(DataGridColumn); }
        get style() { return this.__style.get(); }
        set style(newValue) { this.__style.set(newValue); }
        /**
    ...
    class DataGridColumn extends internal.Element {
        ...
        get containerAsDataGrid() { return super.getContainerAs(DataGrid); }
        /**
         * The value of this property is conceptually of type paths.LegacyAttributePath.
         *
         * In version 7.11.0: deleted
        ...
        get style() { return this.__style.get(); }
        set style(newValue) { this.__style.set(newValue); }
        get oddRowsCell() { return this.__oddRowsCell.get(); }
        set oddRowsCell(newValue) { this.__oddRowsCell.set(newValue); }
        get evenRowsCell() { return this.__evenRowsCell.get(); }
        set evenRowsCell(newValue) { this.__evenRowsCell.set(newValue); }
    ...
    class DocumentTemplate extends projects_1.projects.Document {
        ...
        get toplevels() { return this.__toplevels.get(); }
        get canvasWidth() { return this.__canvasWidth.get(); }
        set canvasWidth(newValue) { this.__canvasWidth.set(newValue); }
        get pageWidth() { return this.__pageWidth.get(); }
        set pageWidth(newValue) { this.__pageWidth.set(newValue); }
        get pageHeight() { return this.__pageHeight.get(); }
        set pageHeight(newValue) { this.__pageHeight.set(newValue); }
        get ppi() { return this.__ppi.get(); }
        set ppi(newValue) { this.__ppi.set(newValue); }
        ...
        get style() { return this.__style.get(); }
        set style(newValue) { this.__style.set(newValue); }
        get header() { return this.__header.get(); }
        set header(newValue) { this.__header.set(newValue); }
        get footer() { return this.__footer.get(); }
        set footer(newValue) { this.__footer.set(newValue); }
        get showHeaderAndFooterOnFirstPage() { return this.__showHeaderAndFooterOnFirstPage.get(); }
        set showHeaderAndFooterOnFirstPage(newValue) { this.__showHeaderAndFooterOnFirstPage.set(newValue); }
        /**
    ...
    class DynamicImageViewer extends EntityWidget {
        ...
        get useThumbnail() { return this.__useThumbnail.get(); }
        set useThumbnail(newValue) { this.__useThumbnail.set(newValue); }
    ...
    class DynamicLabel extends AttributeWidget {
        ...
        get style() { return this.__style.get(); }
        set style(newValue) { this.__style.set(newValue); }
        get renderXHTML() { return this.__renderXHTML.get(); }
        set renderXHTML(newValue) { this.__renderXHTML.set(newValue); }
        get formattingInfo() { return this.__formattingInfo.get(); }
        set formattingInfo(newValue) { this.__formattingInfo.set(newValue); }
        /**
    ...
    class Footer extends DropZone {
        ...
        get containerAsDocumentTemplate() { return super.getContainerAs(DocumentTemplate); }
        get bottomMargin() { return this.__bottomMargin.get(); }
        set bottomMargin(newValue) { this.__bottomMargin.set(newValue); }
        /**
    ...
    class Header extends DropZone {
        ...
        get containerAsDocumentTemplate() { return super.getContainerAs(DocumentTemplate); }
        get topMargin() { return this.__topMargin.get(); }
        set topMargin(newValue) { this.__topMargin.set(newValue); }
        /**
    ...
    class Style extends internal.Element {
        ...
        get containerAsDataGridCell() { return super.getContainerAs(DataGridCell); }
        get containerAsDataGridColumn() { return super.getContainerAs(DataGridColumn); }
        get containerAsDocumentTemplate() { return super.getContainerAs(DocumentTemplate); }
        get containerAsDynamicLabel() { return super.getContainerAs(DynamicLabel); }
        get containerAsGrid() { return super.getContainerAs(Grid); }
        get containerAsStaticLabel() { return super.getContainerAs(StaticLabel); }
        get containerAsTable() { return super.getContainerAs(Table); }
        get containerAsTableCell() { return super.getContainerAs(TableCell); }
        get containerAsTitle() { return super.getContainerAs(Title); }
        get fontFamily() { return this.__fontFamily.get(); }
        set fontFamily(newValue) { this.__fontFamily.set(newValue); }
        get fontSize() { return this.__fontSize.get(); }
        set fontSize(newValue) { this.__fontSize.set(newValue); }
        get bold() { return this.__bold.get(); }
        set bold(newValue) { this.__bold.set(newValue); }
        get italic() { return this.__italic.get(); }
        set italic(newValue) { this.__italic.set(newValue); }
        get fontColor() { return this.__fontColor.get(); }
        set fontColor(newValue) { this.__fontColor.set(newValue); }
        get backgroundColor() { return this.__backgroundColor.get(); }
        set backgroundColor(newValue) { this.__backgroundColor.set(newValue); }
        get overrideFontFamily() { return this.__overrideFontFamily.get(); }
        set overrideFontFamily(newValue) { this.__overrideFontFamily.set(newValue); }
        get overrideFontSize() { return this.__overrideFontSize.get(); }
        set overrideFontSize(newValue) { this.__overrideFontSize.set(newValue); }
        get overrideBold() { return this.__overrideBold.get(); }
        set overrideBold(newValue) { this.__overrideBold.set(newValue); }
        get overrideItalic() { return this.__overrideItalic.get(); }
        set overrideItalic(newValue) { this.__overrideItalic.set(newValue); }
        get overrideFontColor() { return this.__overrideFontColor.get(); }
        set overrideFontColor(newValue) { this.__overrideFontColor.set(newValue); }
        get overrideBackgroundColor() { return this.__overrideBackgroundColor.get(); }
        set overrideBackgroundColor(newValue) { this.__overrideBackgroundColor.set(newValue); }
        get borderStyleTop() { return this.__borderStyleTop.get(); }
        set borderStyleTop(newValue) { this.__borderStyleTop.set(newValue); }
        get borderStyleBottom() { return this.__borderStyleBottom.get(); }
        set borderStyleBottom(newValue) { this.__borderStyleBottom.set(newValue); }
        get borderStyleLeft() { return this.__borderStyleLeft.get(); }
        set borderStyleLeft(newValue) { this.__borderStyleLeft.set(newValue); }
        get borderStyleRight() { return this.__borderStyleRight.get(); }
        set borderStyleRight(newValue) { this.__borderStyleRight.set(newValue); }
        get borderWidthTop() { return this.__borderWidthTop.get(); }
        set borderWidthTop(newValue) { this.__borderWidthTop.set(newValue); }
        get borderWidthBottom() { return this.__borderWidthBottom.get(); }
        set borderWidthBottom(newValue) { this.__borderWidthBottom.set(newValue); }
        get borderWidthLeft() { return this.__borderWidthLeft.get(); }
        set borderWidthLeft(newValue) { this.__borderWidthLeft.set(newValue); }
        get borderWidthRight() { return this.__borderWidthRight.get(); }
        set borderWidthRight(newValue) { this.__borderWidthRight.set(newValue); }
        get borderColorTop() { return this.__borderColorTop.get(); }
        set borderColorTop(newValue) { this.__borderColorTop.set(newValue); }
        get borderColorBottom() { return this.__borderColorBottom.get(); }
        set borderColorBottom(newValue) { this.__borderColorBottom.set(newValue); }
        get borderColorLeft() { return this.__borderColorLeft.get(); }
        set borderColorLeft(newValue) { this.__borderColorLeft.set(newValue); }
        get borderColorRight() { return this.__borderColorRight.get(); }
        set borderColorRight(newValue) { this.__borderColorRight.set(newValue); }
        get textAlign() { return this.__textAlign.get(); }
        set textAlign(newValue) { this.__textAlign.set(newValue); }
        get customStyles() { return this.__customStyles.get(); }
        set customStyles(newValue) { this.__customStyles.set(newValue); }
        /**
    ...
    class Table extends Widget {
        ...
        get columnWeights() { return this.__columnWeights.get(); }
        get cellSpacing() { return this.__cellSpacing.get(); }
        set cellSpacing(newValue) { this.__cellSpacing.set(newValue); }
        get cellPadding() { return this.__cellPadding.get(); }
        set cellPadding(newValue) { this.__cellPadding.set(newValue); }
    ...
    class TableCell extends DropZone {
        ...
        get containerAsTableRow() { return super.getContainerAs(TableRow); }
        get colSpan() { return this.__colSpan.get(); }
        set colSpan(newValue) { this.__colSpan.set(newValue); }
        get rowSpan() { return this.__rowSpan.get(); }
        set rowSpan(newValue) { this.__rowSpan.set(newValue); }
        get isPartOfSpan() { return this.__isPartOfSpan.get(); }
        set isPartOfSpan(newValue) { this.__isPartOfSpan.set(newValue); }
        get style() { return this.__style.get(); }
        set style(newValue) { this.__style.set(newValue); }
        /**
    ...
    class TableRow extends internal.Element {
        ...
        get conditionSettings() { return this.__conditionSettings.get(); }
        set conditionSettings(newValue) { this.__conditionSettings.set(newValue); }
        /**
    ...
    class TemplateGrid extends Grid {
        ...
        get oddRowsContents() { return this.__oddRowsContents.get(); }
        set oddRowsContents(newValue) { this.__oddRowsContents.set(newValue); }
        get evenRowsContents() { return this.__evenRowsContents.get(); }
        set evenRowsContents(newValue) { this.__evenRowsContents.set(newValue); }
        /**
