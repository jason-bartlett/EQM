...
(function (customwidgets) {
    ...
    class CustomWidget extends pages_1.pages.Widget {
        ...
        get object() { return this.__object.get(); }
        set object(newValue) { this.__object.set(newValue); }
        /**
        ...
        static createInBuildingBlockUnderWidget(container) {
            internal.createInVersionCheck(container.model, CustomWidget.structureTypeName, { start: "7.7.0" });
        ...
        static createInDataViewUnderFooterWidget(container) {
            internal.createInVersionCheck(container.model, CustomWidget.structureTypeName, { start: "6.7.0" });
        ...
        static createInMasterDetailRegionUnderWidget(container) {
            internal.createInVersionCheck(container.model, CustomWidget.structureTypeName, { start: "7.1.0" });
            return internal.instancehelpers.createElement(container, CustomWidget, "widget", false);
        }
        /**
         * Creates and returns a new CustomWidget instance in the SDK and on the server.
    ...
    CustomWidget.versionInfo = new exports.StructureVersionInfo({}, internal.StructureType.Element);
    ...
    class CustomWidgetType extends internal.Element {
        ...
        get containerAsCustomWidget() { return super.getContainerAs(CustomWidget); }
        get widgetId() { return this.__widgetId.get(); }
        set widgetId(newValue) { this.__widgetId.set(newValue); }
        get needsEntityContext() { return this.__needsEntityContext.get(); }
        set needsEntityContext(newValue) { this.__needsEntityContext.set(newValue); }
        ...
        get phoneGapEnabled() { return this.__phoneGapEnabled.get(); }
        set phoneGapEnabled(newValue) { this.__phoneGapEnabled.set(newValue); }
        get offlineCapable() { return this.__offlineCapable.get(); }
        set offlineCapable(newValue) { this.__offlineCapable.set(newValue); }
        /**
         * In version 7.1.0: deleted
         * In version 7.0.0: introduced
         */
        get experimentalApi() { return this.__experimentalApi.get(); }
        set experimentalApi(newValue) { this.__experimentalApi.set(newValue); }
        get objectType() { return this.__objectType.get(); }
        set objectType(newValue) { this.__objectType.set(newValue); }
        /**
    ...
    class WidgetEnumerationValue extends internal.Element {
        ...
        get containerAsWidgetValueType() { return super.getContainerAs(WidgetValueType); }
    ...
    class WidgetObject extends internal.Element {
        ...
        get containerAsCustomWidget() { return super.getContainerAs(CustomWidget); }
        get containerAsWidgetValue() { return super.getContainerAs(WidgetValue); }
        /**
    ...
    class WidgetObjectType extends internal.Element {
        ...
        get containerAsCustomWidgetType() { return super.getContainerAs(CustomWidgetType); }
        get containerAsWidgetValueType() { return super.getContainerAs(WidgetValueType); }
        get propertyTypes() { return this.__propertyTypes.get(); }
        /**
    ...
    class WidgetProperty extends internal.Element {
        ...
        get containerAsWidgetObject() { return super.getContainerAs(WidgetObject); }
        /**
         * In version 7.13.0: added optional
         */
        get type() { return this.__type.get(); }
    ...
    class WidgetPropertyType extends internal.Element {
        ...
        get containerAsWidgetObjectType() { return super.getContainerAs(WidgetObjectType); }
        get key() { return this.__key.get(); }
        set key(newValue) { this.__key.set(newValue); }
        get category() { return this.__category.get(); }
        set category(newValue) { this.__category.set(newValue); }
        get caption() { return this.__caption.get(); }
        set caption(newValue) { this.__caption.set(newValue); }
        get description() { return this.__description.get(); }
        set description(newValue) { this.__description.set(newValue); }
        get isDefault() { return this.__isDefault.get(); }
        set isDefault(newValue) { this.__isDefault.set(newValue); }
        /**
         * In version 7.13.0: added optional
         */
        get valueType() { return this.__valueType.get(); }
        set valueType(newValue) { this.__valueType.set(newValue); }
        /**
    ...
    class WidgetReturnType extends internal.Element {
        ...
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get isList() { return this.__isList.get(); }
        set isList(newValue) { this.__isList.set(newValue); }
        get entityProperty() { return this.__entityProperty.get(); }
        set entityProperty(newValue) { this.__entityProperty.set(newValue); }
        /**
    ...
    class WidgetValue extends internal.Element {
        ...
        get containerAsWidgetProperty() { return super.getContainerAs(WidgetProperty); }
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get primitiveValue() { return this.__primitiveValue.get(); }
        set primitiveValue(newValue) { this.__primitiveValue.set(newValue); }
        /**
        ...
        get translatableValue() { return this.__translatableValue.get(); }
        set translatableValue(newValue) { this.__translatableValue.set(newValue); }
        /**
    ...
    class WidgetValueType extends internal.Element {
        ...
        get containerAsWidgetPropertyType() { return super.getContainerAs(WidgetPropertyType); }
        get type() { return this.__type.get(); }
        set type(newValue) { this.__type.set(newValue); }
        get isList() { return this.__isList.get(); }
        set isList(newValue) { this.__isList.set(newValue); }
        get entityProperty() { return this.__entityProperty.get(); }
        set entityProperty(newValue) { this.__entityProperty.set(newValue); }
        get allowNonPersistableEntities() { return this.__allowNonPersistableEntities.get(); }
        set allowNonPersistableEntities(newValue) { this.__allowNonPersistableEntities.set(newValue); }
        get isPath() { return this.__isPath.get(); }
        set isPath(newValue) { this.__isPath.set(newValue); }
        get pathType() { return this.__pathType.get(); }
        set pathType(newValue) { this.__pathType.set(newValue); }
        get parameterIsList() { return this.__parameterIsList.get(); }
        set parameterIsList(newValue) { this.__parameterIsList.set(newValue); }
        get multiline() { return this.__multiline.get(); }
        set multiline(newValue) { this.__multiline.set(newValue); }
        ...
        get attributeTypes() { return this.__attributeTypes.get(); }
        get enumerationValues() { return this.__enumerationValues.get(); }
        get objectType() { return this.__objectType.get(); }
        set objectType(newValue) { this.__objectType.set(newValue); }
